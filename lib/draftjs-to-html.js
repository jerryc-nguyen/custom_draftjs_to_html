...
function getBlockMarkup(block, entityMap, hashtagConfig, directional, customEntityTransform) {
  ...
  if (isAtomicEntityBlock(block)) {
    ...
    if (block.type == "image") {
      ...
      var src = block.data.url;
      var width = block.data.width;
      var height = block.data.height;
      var caption = block.text;
      var imageHtml = "<figure><img src='" + src + "' alt='" + caption + "' width='" + width + "' height='" + height + "'><figcaption>" + caption + "</figcaption></figure>";
      blockHtml.push(imageHtml);
    } else {
